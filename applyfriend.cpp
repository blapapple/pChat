...
ApplyFriend::ApplyFriend(QWidget* parent)
    ...
    connect(ui->cancel_btn, &QPushButton::clicked, this,
            &ApplyFriend::slot_apply_cancel);
    connect(ui->sure_btn, &QPushButton::clicked, this,
            &ApplyFriend::slot_apply_sure);
}
...
void ApplyFriend::addLabel(QString name) {
    ...
    connect(tmplabel, &FriendLabel::sig_close, this,
            &ApplyFriend::slot_remove_friend_label);
...
void ApplyFriend::slot_change_friend_label_by_tip(QString lbtext,
                                                  ClickLbState state) {
...
void ApplyFriend::slot_label_edit_finished() { ui->input_tip_widget->hide(); }
