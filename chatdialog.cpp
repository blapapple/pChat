...
std::vector<QString> heads = {
    ":/resources/images/head_1.jpg",
    ":/resources/images/head_2.jpg",
    ":/resources/images/head_3.jpg",
    ":/resources/images/head_4.jpg",
...
void ChatDialog::addChatUserList()
{
    //创建item
    for(int i = 0; i < 25; i++){
        int randomValue = QRandomGenerator::global()->bounded(100); //生成0-99随机整数
