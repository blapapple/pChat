...
void LoginDialog::InitHead(){
    ...
    originalPixmap = originalPixmap.scaled(ui->labelLoginHead->size(), Qt::KeepAspectRatio, Qt::SmoothTransformation);
    ...
    QPainterPath path;
    path.addRoundedRect(0, 0, originalPixmap.width(), originalPixmap.height(), 10, 10);//设置圆角弧度
