...
MainWindow::MainWindow(QWidget *parent)
    ...
    _login_dlg->setWindowFlags(Qt::CustomizeWindowHint |
                               Qt::FramelessWindowHint);
    setCentralWidget(_login_dlg);

    connect(_login_dlg, &LoginDialog::SwitchRegister, this,
            &MainWindow::SlotSwitchReg);
    connect(_login_dlg, &LoginDialog::SwitchReset, this,
...
void MainWindow::SlotSwitchReset() {
    ...
    _reset_dlg->setWindowFlags(Qt::CustomizeWindowHint |
                               Qt::FramelessWindowHint);
    ...
    connect(_reset_dlg, &ResetDialog::switchLogin, this,
            &MainWindow::SlotSwitchLoginFromReset);
}
...
void MainWindow::SlotSwitchChat() {
    ...
    _chat_dlg->setWindowFlags(Qt::CustomizeWindowHint |
                              Qt::FramelessWindowHint);
